...
def get_model_from_db_selection(db_selection):
    if db_selection == "Anime DB":
        input_video_path = 'PAIR/TTVO-controlnet-canny-anime'
    elif db_selection == "Avatar DB":
        input_video_path = 'PAIR/TTVO-controlnet-canny-avatar'
    elif db_selection == "GTA-5 DB":
        input_video_path = 'PAIR/TTVO-controlnet-canny-gta5'
    elif db_selection == "Arcane DB":
        input_video_path = 'PAIR/TTVO-controlnet-canny-arcane'
    else:
...
def logo_name_to_path(name):
    logo_paths = {
        ...
        'TTVO': '__assets__/t2v-z_watermark.png',
        'None': None
    }
